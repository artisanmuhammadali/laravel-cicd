    ...
    <div id="account-details" class="mx-md-5 content active dstepper-block" role="tabpanel" aria-labelledby="account-details-trigger">
        <div class="content-header mb-2">
            ...
            <ul>
                ...
                <li>
                    All ID documents must be a colour photo of the ID, best taken with the phone, where all the details are well lit and clearly shown. Do not upload a scan from an image scanner as it might cause verification issues.
                </li>
            </ul>
        </div>
