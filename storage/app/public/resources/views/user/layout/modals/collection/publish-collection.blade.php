        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('user.collection.save')}}" method="POST">
                    @csrf
                    <button data-form="publish" data-publish="1" data-link="{{route('user.collection.save')}}" type="button" class="update_cols btn btn-primary waves-effect waves-float waves-light">Sure</button>
                </form>
            </div>
        </div>
        @endif
