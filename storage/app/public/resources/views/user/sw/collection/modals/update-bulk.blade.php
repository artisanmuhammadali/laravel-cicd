                ...
                <form action="{{route('user.collection.sw.save')}}" class="submit_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-50 d-flex justify-content-end">
                                <button data-form="bulk" data-link="{{route('user.collection.sw.save')}}" type="button" class="submit_collection_formm btn btn-outline-secondary waves-effect" >Update</button>
                        </div>
                    </div>
                </form>
            </div>
