                        ...
                        <div class="card-header d-flex justify-content-center px-sm-2 px-0">
                            ...
                            <div class="row d-flex w-100 justify-content-between bg-white ">
                                <div class="col-4 px-md-2 py-1 ">
                                    <a href="{{ route('user.collection.sw.index',['single']) }}">
                                ...
                                <div class="col-4 px-md-2 py-1">
                                    <a href="{{ route('user.collection.sw.index',['sealed']) }}">
                                ...
                                <div class="col-4 px-md-2 py-1">
                                    <a href="{{ route('user.collection.sw.index',['completed']) }}">
                            ...
                            <div class="row d-flex w-100 justify-content-between px-md-50 px-0 ">
                                ...
                                <div class="col-md-6 d-flex justify-content-between text-center d-grid gap-2">
                                    ...
                                    <a href="{{route('user.collection.sw.bulk.upload',$type)}}" type="button"
                                    ...
                                    @if($type == "singlee")
                                    <a href="{{route('user.collection.sw.csv.upload',$type)}}" type="button"
                                        class="btn btn-outline-primary waves-effect fs-sm-drop w-100 mt-sm-0 mt-50" title="Add">
                            ...
                            @include('user.sw.collection.components.filter')
                            <div class="">
                                @include('user.sw.collection.components.filterCollections')
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 ">
                                        <div class="append_cards">
                                            ...
                                            @include('user.sw.collection.components.table')
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@include('user.sw.collection.modals.add-card',['route' => route('user.collection.sw.search.cards')])
@include('user.sw.collection.modals.publish-collection')
@include('user.sw.collection.modals.inactive-collection')
@include('user.sw.collection.modals.bulk-delete')
@include('user.sw.collection.modals.update-price')
@include('user.sw.collection.modals.csv-upload')
@include('user.sw.collection.modals.prevent')
@include('user.sw.collection.modals.update-bulk')
@endsection
@push('js')
<script>
...
@include('user.components.collection.script',['id'=>$auth->id , 'blade'=>'collectionPg'])
@endpush
