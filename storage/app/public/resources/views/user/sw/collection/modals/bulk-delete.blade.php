        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('user.collection.delete')}}" method="POST">
                    @csrf
                    <button data-form="bulk"  data-link="{{route('user.collection.sw.delete')}}" type="button" class="submit_collection_formm btn btn-danger waves-effect waves-float waves-light">Sure</button>
                </form>
            </div>
        </div>
    </div>
