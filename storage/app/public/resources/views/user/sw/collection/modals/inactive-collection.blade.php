        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('user.collection.save')}}" method="POST">
                    @csrf
                    <button data-form="publish" data-publish="0" data-link="{{route('user.collection.sw.save')}}" type="button" class=" submit_collection_formm btn btn-primary waves-effect waves-float waves-light ">Sure</button>
                </form>
            </div>
        </div>
    </div>
