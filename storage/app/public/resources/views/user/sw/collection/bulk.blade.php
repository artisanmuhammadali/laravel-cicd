                    ...
                    <div class="card">
                        <div class="card-header text-start d-flex justify-content-center">
                            ...
                            <div class="mt-m50p-sm">
                                @include('user.sw.collection.components.filterCollections',['isBulk' => true])
                            </div>
                           
                        </div>
                        @include('user.collection.components.filter')
        
                        <form action="{{route('user.collection.sw.save')}}" id="BulkCollectionForm" method="POST">
                            @csrf
                            <input type="hidden" name="form_type" value="bulk">
                            <input type="hidden" name="card_type" value="{{request()->type}}">
