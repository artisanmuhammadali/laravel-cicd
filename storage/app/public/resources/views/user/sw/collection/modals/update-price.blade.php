    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('user.collection.sw.update.price')}}" method="POST">
                    @csrf
                    ...
                    <div class="col-12 d-flex justify-content-end">
                        <button data-link="{{route('user.collection.sw.update.price')}}" type="button" class="submit_collection_formm btn btn-primary waves-effect waves-float waves-light mt-1">Apply</button>
                    </div>
                </form>
            </div>
        </div>
