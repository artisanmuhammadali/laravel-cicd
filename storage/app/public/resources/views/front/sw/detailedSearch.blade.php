    ...
    <section>
        <div class="container px-md-0">
            <div class="row mx-md-0 m-2">
                ...
                <form class="shadow_site p-md-5 p-3" method="GET" action="{{route('sw.detailed.search')}}">
                    <div class="row py-3">
                        <div class="col-md-4">
                    ...
                    <div class="row py-3">
                        <div class="col-md-4">
                            <label class="fw-bold fs-5">Arena:</label>
                            <p class="sm-text text-body-secondary fst-italic">Select one </p>
                        </div>
                        <div class="col-md-8">
                            <select name="arena" class="form-select rounded-0 form-select-lg border-site-primary mb-2">
                                <option class="form-control" selected value="">Choose Arena 1</option>
                                <option class="form-control" value="Ground">Ground</option>
                                <option class="form-control" value="Space">Space</option>
                            </select>
                        </div>
                    </div>
                    <div class="row py-3">
                        <div class="col-md-4">
                            <label class="fw-bold fs-5">Type:</label>
                            <p class="sm-text text-body-secondary fst-italic">Select one </p>
                        </div>
                        <div class="col-md-8">
                            <select name="type" class="form-select rounded-0 form-select-lg border-site-primary mb-2">
                                <option class="form-control" selected value="">Choose Type</option>
                                @foreach(wsCardsTypes() as $type)
                    ...
                    <div class="row py-3">
                        <div class="col-md-4">
                            <label class="fw-bold fs-5">Traits:</label>
                            <p class="sm-text text-body-secondary fst-italic">Select one </p>
                        </div>
                        <div class="col-md-8">
                            <select name="trait" class="form-select rounded-0 form-select-lg border-site-primary mb-2">
                                <option class="form-control" selected value="">Choose Traits</option>
                                   
                                @foreach(wsCardsTraits() as $type)
                                <option class="form-control" value="{{$type}}">{{$type}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row py-3">
                        <div class="col-md-4">
                            <label for="name" class="fw-bold fs-5">Stats:</label>
                            <p class="sm-text text-body-secondary fst-italic">Select Cost/Power/HP, condition ,value</p>
                        </div>
                        <div class="col-md-2">
                            <select name="strength" class="form-select rounded-0 form-select-lg border-site-primary px-2 mb-2  fs-md-9">
                                ...
                                <option class="form-control" value="cost">Cost</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="parameter-input">
                                    <div class="aspect-container">
                                      ...
                                      <label>
                                        <input type="checkbox" name="rarity[]" value="legendary">
                                        <span class="aspect-name rarity-text">Legendary</span>
                                      </label>
                                      <label>
                                        <input type="checkbox" name="rarity[]" value="starter">
                    ...
                    <div class="row py-3">
                        ...
                        <div class="col-md-8">
                            <select name="language" id="language" class="form-select rounded-0 form-select-lg border-site-primary">
                                <option class="form-control " selected="" value="">Select one...</option>
