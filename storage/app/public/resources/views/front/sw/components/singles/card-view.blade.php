<div class="col-lg-4 col-md-6 mb-3">
    <div class="card border-0 bg-transparent" >
        <a href="{{route('sw.expansion.detail',[$item->set->slug, $item->url_type ,$item->slug])}}" class="text-decoration-none text-black">
            <div class="row px-5 mb-2">
                <div class="col-2 bg-light-blue justify-content-center d-flex align-items-center">
                    <img loading="lazy" src="{{getStarWarIcon()}}" style="filter: url({{"#".$item->rarity."_rarity"}});height: 23px;" class="img-fluid lozad" width="30"    alt="">
                </div>
