    ...
    <div class="card-header border-0 bg-transparent">
        <div class="row mx-md-2">
            <div class="col-2 col-md-1 bg-light-blue text-center d-flex aligns-items-center">
                <img loading="lazy" class="m-auto img-fluid px-xxl-4 px-xl-3 py-2 lozad"
                    src="{{getStarWarIcon()}}" style="filter: url({{"#".$item->rarity."_rarity"}});" alt="">
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr class="product_cart_row" data-collection="{{$collection->id}}">
                            ...
                            <td>
                                <span class="bg-light-blue py-1 px-4 rounded-1">{{$collection->quantity}}</span>
                            </td>
                            <td>
                                <span class="bg-light-blue py-1 px-4 rounded-1">£{{$collection->price}}</span>
                            </td>
                            <td>
