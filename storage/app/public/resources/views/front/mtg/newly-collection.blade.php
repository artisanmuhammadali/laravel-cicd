@extends('layouts.app')
@section('title', 'New MTG Singles & Products | Very Friendly Sharks')
@section('description', "Discover the latest MTG singles and products added daily on Very Friendly Sharks. Dive into our fresh collection and find your next treasure today!")
@push('css')
<style>
