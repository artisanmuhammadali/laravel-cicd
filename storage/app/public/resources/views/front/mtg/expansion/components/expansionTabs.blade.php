        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class=" active" >
                <div class="row ">
                    ...
                    @include('front.components.singles.best-price' , ['item'=>$item])
                    @endforeach
                </div>
            </div>
            ...
            <div class=""  >
                <div class="row shadow_site  py-5">
                    @foreach($list as $item)
                    @include('front.components.singles.card-view', ['item'=>$item])
                    @endforeach
                </div>
            </div>
            @else
            <div class="" >
                <div class="row shadow_site p-3">
                    @include('front.components.singles.list-view', ['list'=>$list])
                </div>
            </div>
            @endif
        </div>
