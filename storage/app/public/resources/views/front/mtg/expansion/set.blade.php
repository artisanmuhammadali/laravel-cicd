...
<div class="container-fluid px-0">
    @if(isset($set->banner))
        @include('front.components.set.has-banner',['detail'=>$set , 'banner'=>$set->banner])
    @else
        @include('front.components.set.no-banner',['detail'=>$set])
    @endif
    <section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 ">
                        <a href="{{ route('mtg.expansion.type',[$set->slug ,'single-cards']) }}" class="text-decoration-none">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="card border-0 card-set d-flex justify-content-center ">
                            <a href="{{ route('mtg.expansion.type',[$set->slug ,'sealed-products']) }}" class="text-decoration-none text-black">
                                <div class="set_card_img d-flex justify-content-center px-sm-3 px-5">
                                    <img src="{{$set->first_sealed_card->png_image ?? ''}}" loading="lazy" class="img-fluid" alt="sealed_card"  width="100%">
                                </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="card border-0 card-set ">
                            <a href="{{ route('mtg.expansion.type',[$set->slug ,'complete-sets']) }}" class="text-decoration-none text-black">
                                <div class="set_card_img text-center">
                                    <img src="{{$set->first_completed_card->png_image ?? ""}}" class="img-fluid" alt="completed_card">
                                </div>
                                <div class="card-footer border-0 bg-white text-center">
