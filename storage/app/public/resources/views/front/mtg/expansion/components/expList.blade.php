<div class="row shadow_site  py-3">
    ...
    <div class="col-md-6 col-12 exp-set">
        <ul class="list-group expSet">
            <li class="list-group-item mb-4 bg_dark_shark rounded-0 text-white py-3">
                <h2 class=" fs-4 mb-0 text-uppercase">Expansion Sets ({{ count($sets['expansion']) }})</h2>
            </li>


            @foreach ($sets['expansion'] as $setOption)
