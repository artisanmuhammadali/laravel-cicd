@if($type == "single-cards")
<div class="row mx-md-0">
    <form class="p-md-5 p-0 marketplace-filter" method="GET" action="{{request()->url()}}">
                ...
                <div class="row">
                    <div class="col-8 pe-0">
                        <input type="text" id="name" name="name"
                            class="form-control form-control-lg form-control-site-lg border-site-primary rounded-0 text-center"
                            placeholder="e.g: 'Bolas'">
                    </div>
                    <div class="col-4 ps-0">
                        <div class="">
                            <select name="exact_card_name"
                                class="form-select rounded-0 form-select-lg border-site-primary mb-2">
        ...
        <div class="row py-3">
            ...
            <div class="col-md-8">
                <input type="text" id="within_text" name="within_text"
                    class="form-control form-control-lg form-control-site-lg border-site-primary rounded-0 text-center"
                    placeholder="e.g : 'Scratch on back'">
            </div>
        </div>
        <div class="row py-3">
            <div class="col-md-4">
        ...
        <div class="row py-3">
            ...
            <div class="col-md-8">
                <input type="text" id="card_type" name="card_type"
                    class="py-0 tags form-control form-control-lg form-control-site-lg border-site-primary rounded-0 text-center"
                    placeholder="e.g : 'Warior' , 'Bolas' ">
            </div>
        </div>
        <div class="row py-3">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="text-center pe-3 w-auto">
                        <input type="checkbox" id="myCheckbox8" value="foil" name="characters[]">
                    ...
                    <div class="text-center pe-3 w-auto">
                        <input type="checkbox" id="myCheckbox9" value="non_foil" name="characters[]">
                    ...
                    <div class="text-center pe-3 w-auto">
                        <input type="checkbox" id="myCheckbox10" value="etched" name="characters[]">
                    ...
                    <div class="text-center pe-3 w-auto">
                        <input type="checkbox" id="myCheckbox11" value="signed" name="characters[]">
                    ...
                    <div class="text-center pe-3 w-auto">
                        <input type="checkbox" id="myCheckbox12" value="graded" name="characters[]">
                    ...
                    <div class="text-center pe-3 w-auto">
                        <input type="checkbox" id="myCheckbox13" value="altered" name="characters[]">
        ...
        <div class="row py-3">
            ...
            <div class="col-md-4">
                <select name="cmc_order" class="form-select rounded-0 form-select-lg border-site-primary mb-2">
                    ...
                    <option class="form-control" value="<">Less Than, <</option> <option class="form-control" value="=">
                            Equal To, =</option>
                </select>
            </div>
            <div class="col-md-4">
                <input type="number" name="cmc_value" min="0"
                    class="form-control form-control-lg form-control-site-lg border-site-primary rounded-0 text-center"
                    placeholder="e.g :'5' ">
            </div>
        </div>
        <div class="row py-3">
            ...
            <div class="col-md-3">
                <input type="number" min="0" name="strength_value"
                    class="form-control form-control-lg form-control-site-lg border-site-primary rounded-0 text-center"
                    placeholder="e.g :'5'">
            </div>
        </div>
        ...
        <div class="row py-3">
            ...
            <div class="col-md-3">
                <div class="alert alert-warning rounded-0"><span class="fw-bold">Other:</span> Contain Schemes, Planes &
                    Tokens</div>
            </div>
        </div>
        <div class="row py-3">
        ...
        <div class="row py-3">
            ...
            <div class="col-md-8">
                <select name="fill_condition" id="condition" class="form-select rounded-0 form-select-lg border-site-primary">
        ...
        <div class="row py-3">
            ...
            <div class="col-md-8">
                <select name="fill_lang" id="language" class="form-select rounded-0 form-select-lg border-site-primary">
                    <option class="form-control " selected="" disabled="">Select one...</option>
...
@else
<div class="row w-100">
    <div class="col-lg-12 col-12 d-md-flex align-items-center justify-content-center mt-1">
        <div class="col-md-5 text-center">
            <label class="fw-bold fs-5">Characteristics:</label>
        ...
        <div class="col-md-7">
            <div class="row d-flex justify-content-center">
                <div class="text-center pe-3 w-auto">
                    <input type="checkbox" class="characteristics" id="myCheckbox12" value="foil"
                        name="characterstics[]">
                    <label for="myCheckbox12" class="p-0 m-0">
                        <img src="{{asset('images/characterstics/foil.png')}}" loading="lazy" alt="Foil">
                    </label>
                    <p class="sm-text fw-bolder">Foil</p>
                </div>
                <div class="text-center pe-3 w-auto">
                    <input type="checkbox" class="characteristics" id="myCheckbox13" value="signed"
                        name="characterstics[]">
                    <label for="myCheckbox13" class="p-0 m-0">
                ...
                <div class="text-center pe-3 w-auto">
                    <input type="checkbox" class="characteristics" id="myCheckbox14" value="graded"
                        name="characterstics[]">
                    <label for="myCheckbox14" class="p-0 m-0">
                ...
                <div class="text-center pe-3 w-auto">
                    <input type="checkbox" class="characteristics" id="myCheckbox15" value="altered"
                        name="characterstics[]">
                    <label for="myCheckbox15" class="p-0 m-0">
    ...
    <div class="row">
        <div class="col-md-4">
            <label for="set_name" class="fw-bold fs-5">Set Name:</label>
        </div>
        <div class="col-md-8">
            <input type="hidden" name="exact_set_name" class="exact_set_name" value="false">
            <input type="text" id="set_name" name="set_name" class="set_name form-control form-control-lg form-control-site-lg border-site-primary rounded-0 text-center" placeholder="e.g : 'Commander'">
        </div>
    </div>
    ...
    <div class="col-lg-12 mt-1">
        <select name="language" id="language"
            ...
            @foreach(allMtgLanguages() as $key=> $lang)
    ...
    <div class="col-lg-12  mt-1 mb-sm-0 mb-1">
        <button class="btn btn-site-primary w-100 filter" title="Filter" data-bs-dismiss="modal"
