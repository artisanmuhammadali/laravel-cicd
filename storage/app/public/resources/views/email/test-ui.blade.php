    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr>
            <td style="text-align: center;font-size: 25px;padding-top: 20px;">
                <h3 style="color: #5da3dc;">ACCOUNT ON HOLIDAY - VERY FRIENDLY SHARKS</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;font-size: 20px;">
                <h4 style="color: #5da3dc;">Hello {{$data['user_name']}}! You’ve just placed your account on holiday.</h4>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
               Thank you for taking the time to place your shop and catalogue on holiday.
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
               We hope to see you again very soon and that, if you do go on holiday, you will have a great time off.
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
                Also, while we have you here, did you know that scientists can know theage of sharks by counting the rings on their vertebrae🦈that’s like counting the age of a tree.
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
        ...
        <tr>
            <td style="justify-content: center;text-align: center; padding-top: 15px;padding-bottom: 15px;">
                <a  href="{{route('help')}}" style="-webkit-text-size-adjust: none; border-radius: 4px;color: #fff; display: inline-block;overflow: hidden;text-decoration: none; background-color: #2d3748;border-bottom: 8px solid #2d3748;border-left: 18px solid #2d3748;border-right: 18px solid #2d3748;border-top: 8px solid #2d3748;">Help</a>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
