    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr>
            <td style="text-align: center;font-size: 25px;padding-top: 20px;">
                <h3 style="color: #5da3dc;">ACCOUNT IS ACTIVATED - VERY FRIENDLY SHARKS</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;font-size: 20px;">
                <h4 style="color: #5da3dc;">Hello !  WELCOME BACK. YOU’VE JUST ACTIVATED YOUR ACCOUNT BACK.</h4>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
               I hope this message finds you well and refreshed from your holiday break. Once again, welcome back! Here's to a fantastic journey ahead filled with success, collaboration, and shared accomplishments.
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
               If you need any support catching up or transitioning back into the workflow, please don't hesitate to reach out. We're here to make your return as smooth as possible.
            </td>
        </tr>
        <tr>
