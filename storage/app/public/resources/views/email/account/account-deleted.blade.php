    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr>
            <td style="text-align: center;font-size: 25px;padding-top: 20px;">
                <h3 style="color: #5da3dc;">ACCOUNT DELETED - VERY FRIENDLY SHARKS</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;font-size: 20px;">
                <h4 style="color: #5da3dc;">Hello {{$data['user_name']}}! ”,your account has been deleted.</h4>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
               We’re sad to see you go, but we wish you all of the best and good luck somewhere else.
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
