    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr>
            <td style="text-align: center;font-size: 25px;padding-top: 20px;">
                <h3 style="color: #5da3dc;">ORDER #{{$data['order']->id}} SHIPPED - VERY FRIENDLY SHARKS</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;font-size: 20px;">
                <h4 style="color: #5da3dc;">Hello {{$data['order']->buyer->user_name}},we just wanted to let you know that {{$data['order']->seller->user_name}}, has shipped your order.</h4>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
              Tracking Id #{{$data['order']->tracking_id}}
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
        ...
        <tr>
            <td style="text-align: center;">
                The order should be with you soon, and you can get its tracking code by clicking the button below.
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
        ...
        <tr>
            <td style="justify-content: center;text-align: center; padding-top: 15px;padding-bottom: 15px;">
                <a  cellpadding="1" href="{{getPagesRoute('sell-cards')}}"style="-webkit-text-size-adjust: none; border-radius: 4px;color: #fff; display: inline-block;overflow: hidden;text-decoration: none; background-color: #2d3748;border-bottom: 8px solid #2d3748;border-left: 18px solid #2d3748;border-right: 18px solid #2d3748;border-top: 8px solid #2d3748;">Buying Guides</a>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
