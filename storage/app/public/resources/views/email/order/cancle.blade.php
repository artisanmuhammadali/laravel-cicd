    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr>
            <td style="text-align: center;font-size: 25px;padding-top: 20px;">
                <h3 style="color: #5da3dc;"> ORDER CANCELLED  - VERY FRIENDLY SHARKS</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;font-size: 20px;">
                <h4 style="color: #5da3dc;">your order is Cancelled!</h4>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
               The following order has been received on our website:
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
        ...
        <tr>
            <td style="justify-content: center;text-align: center; padding-top: 15px;padding-bottom: 15px;">
                <a  href="{{route('user.order.detail',[$data['order']->id ,$data['type']])}}" style="-webkit-text-size-adjust: none; border-radius: 4px;color: #fff; display: inline-block;overflow: hidden;text-decoration: none; background-color: #2d3748;border-bottom: 8px solid #2d3748;border-left: 18px solid #2d3748;border-right: 18px solid #2d3748;border-top: 8px solid #2d3748;">Order Details</a>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
