    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr>
            <td style="text-align: center;font-size: 25px;padding-top: 20px;">
                <h3 style="color: #5da3dc;">SUCCESSFUL PURCHASE - VERY FRIENDLY SHARKS</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;font-size: 20px;">
                <h4 style="color: #5da3dc;">Thank you {{$data['order']->buyer->user_name}} for your purchase on our website.</h4>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: center;">
               <p><span style="font-weight: 700;">Order Quantity:</span> {{$data['quantity']}}</p>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
        ...
        <tr>
            <td style="text-align: center;">
               We’ve contacted the sellers, and they will be shipping your order soon. Please check the links below to see your order details. We will inform you as soon as the seller has dispatched the items.
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
        ...
        <tr>
            <td style="text-align: center;">
                 Make sure to check our guides before opening your order!
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
               Here at Very Friendly Sharks, we always have your back, but please check all our guides in the links below, especially the“Fakes & Searched Product Guide”.If you follow our guides, you’ll have little to no issues with your orders, and we can better help you.
            </td>
        </tr>
        <tr>
            <td style="justify-content: center;text-align: center; padding-top: 15px;padding-bottom: 15px;">
                <a  cellpadding="1" href="{{getPagesRoute('sell-cards')}}" style="-webkit-text-size-adjust: none; border-radius: 4px;color: #fff; display: inline-block;overflow: hidden;text-decoration: none; background-color: #2d3748;border-bottom: 8px solid #2d3748;border-left: 18px solid #2d3748;border-right: 18px solid #2d3748;border-top: 8px solid #2d3748;">Buyers Guides</a>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
