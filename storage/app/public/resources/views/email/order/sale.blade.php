    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr>
            <td style="text-align: center;font-size: 25px;padding-top: 20px;">
                <h3 style="color: #5da3dc;">SUCCESSFUL SALE  - VERY FRIENDLY SHARKS</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;font-size: 20px;">
                <h4 style="color: #5da3dc;">Congratulations, {{$data['order']->seller->user_name}},you just sold some products!</h4>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: center;">
                We’ve contacted the buyer, and they will be expecting you to shipthe order soon. Please check the links below to see your order details. We will inform the buyers as soon as you’ve dispatched the items.
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
        ...
        <tr>
            <td style="justify-content: center;text-align: center; padding-top: 15px;padding-bottom: 15px;">
                <a  cellpadding="1" href="{{getPagesRoute('sell-cards')}}" style="-webkit-text-size-adjust: none; border-radius: 4px;color: #fff; display: inline-block;overflow: hidden;text-decoration: none; background-color: #2d3748;border-bottom: 8px solid #2d3748;border-left: 18px solid #2d3748;border-right: 18px solid #2d3748;border-top: 8px solid #2d3748;">Sellers Guides</a>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
