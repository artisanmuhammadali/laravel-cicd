    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr>
            <td style="text-align: center;font-size: 25px;padding-top: 20px;">
                <h3 style="color: #5da3dc;">ORDER #{{$data['order']->id}} BUYER OPEN DISPUTE  - VERY FRIENDLY SHARKS</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;font-size: 20px;">
                <h4 style="color: #5da3dc;">Hello {{$data['order']->seller->user_name}}, we just wanted to let you know that {{$data['order']->buyer->user_name}}, has open a dispute on this order.</h4>
            </td>
        </tr>
        <tr>
