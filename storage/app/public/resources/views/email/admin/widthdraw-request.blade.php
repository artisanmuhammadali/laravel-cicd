    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr>
            <td style="text-align: center;font-size: 25px;padding-top: 20px;">
                <h3 style="color: #5da3dc;">Action Required: USER WITHDRAWAL REQUEST</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;font-size: 20px;">
                <h4 style="font-weight: 200;" >{{$data['name']}}, has request for withdraw £ {{$data['amount']}} amount on {{$data['date']}}</h4>
            </td>
        </tr>
        <tr>
