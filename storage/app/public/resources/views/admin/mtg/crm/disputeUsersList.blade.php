                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header border-bottom ">
                                <h4 class="card-title text-capitalize">Disputed Accounts List</h4>
                                <div>
                                    ...
                                    <table class="table table-hover datatables">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $list[$loop->iteration]['no_of_disputes'] = $user->selling_orders_count;
