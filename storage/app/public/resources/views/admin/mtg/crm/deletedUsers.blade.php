                            ...
                            <div class="card-body">
                                <div>
                                    <div class="toolbar w-100">
                                        <form method="GET" action="{{route('admin.mtg.crm.accounts.deleted')}}">
                                            <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card w-100">
                            <div class="card-header border-bottom ">
                                <h4 class="card-title text-capitalize">Deleted Users</h4>
                                <div>
                                    <button class="btn btn-icon btn-outline-success waves-effect downloadData" title="Export in Excel" data-type="deleted-users">
                                        <i data-feather='file-text'></i>
                                    </button>
                                    <button class="btn btn-icon btn-outline-danger waves-effect downloadData downloadPdf" title="Export in PDF" data-type="deleted-users">
                                    ...
                                    <table class="table table-hover datatables">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $totalJson[$loop->iteration]['Delete Users'] = $item->sum('total_users');
                                            ?>
                                            @endforeach
                                        </tbody>
                                    </table>
                        ...
                        <input type="hidden" value="{{json_encode($totalJson)}}" id="deleted-users"> 
                    </div>
                    <div class="col-md-6">
                        <div class="card w-100">
                            <div
