                            ...
                            <div class="card-body">
                                <div>
                                    <div class="toolbar w-100">
                                        <form method="GET" action="{{route('admin.mtg.crm.revenue')}}">
                                            <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card w-100">
                            <div class="card-header border-bottom ">
                                <h4 class="card-title text-capitalize">Revenue Amount</h4>
                                <div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover datatables">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                $RevenueAmount[$loop->iteration]['Area'] = $key;
                                                $RevenueAmount[$loop->iteration]['Total Revenue Amount'] = $item->sum('total_value');
                                            ?>
                                            @endforeach
                                        </tbody>
                                    </table>
                            ...
                            <input type="hidden" value="{{json_encode($RevenueAmount)}}" id="transaction-amount"> 
