                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header border-bottom ">
                                <h4 class="card-title text-capitalize">Reviews</h4>
                                <div>
                                    ...
                                    <table class="table table-hover datatables">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a href="{{route('admin.user.detail',[$user->id , 'info'])}}"
                                                        target="_blank"
                                                        class="btn btn-outline-warning me-1 waves-effect "
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Detail"
                                                        data-bs-original-title="User Detail"><i
                                                            class="fa fa-bars"></i></a>
                                                    <a href="{{route('admin.mtg.conversation',$user->id)}}" target="_blank" class="btn btn-outline-success me-1 waves-effect " data-bs-toggle="tooltip" data-bs-placement="top" title="Chat" data-bs-original-title="CHat"><i class="fa fa-comments"></i></a>
                                            ...
                                            <?php
                                                ...
                                                $list[$loop->iteration]['average_rating'] = $user->average_Rating;
                                            ?>
                                            @endforeach
                                        </tbody>
                                    </table>
