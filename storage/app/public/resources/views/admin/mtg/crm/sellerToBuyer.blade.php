                            ...
                            <div class="card-body">
                                <div>
                                    <div class="toolbar w-100">
                                        <form method="GET" action="{{route('admin.mtg.crm.seller.to.buyer')}}">
                                            <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card w-100">
                            <div class="card-header border-bottom ">
                                <h4 class="card-title text-capitalize">Seller/ Buyer Ratio</h4>
                                <div>
                                    <button class="btn btn-icon btn-outline-success waves-effect downloadData" title="Export in Excel" data-type="seller-to-buyer-ratio">
                                        <i data-feather='file-text'></i>
                                    </button>
                                    <button class="btn btn-icon btn-outline-danger waves-effect downloadData downloadPdf" title="Export in PDF" data-type="seller-to-buyer-ratio">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover datatables">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                $SellerBuyer[$loop->iteration]['Area'] = $item['area'];
                                                $SellerBuyer[$loop->iteration]['Sellers'] = $item['seller'];
                                                $SellerBuyer[$loop->iteration]['Buyer'] = $item['buyer'];
                                                $SellerBuyer[$loop->iteration]['Ratio'] = $item['ratio'].'%';
                                            ?>
                                            @endforeach
                                        </tbody>
                                    </table>
                            ...
                            <input type="hidden" value="{{json_encode($SellerBuyer)}}" id="seller-to-buyer-ratio"> 
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card w-100">
