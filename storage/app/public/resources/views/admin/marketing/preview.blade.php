...
<body style="">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        ...
        @if($data)
            ...
            <tr>
                <td style="text-align:center;padding-bottom: 12px;">
                    We don't like to say goodbye, but you can <a href="{{route('profile.unsubscribe',$data['email'])}}">unsubscribe here</a> if you want to leave from our newsletter list. 
                </td>
            </tr>
            @endif
        @endif
