                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom d-flex justify-content-between">
                                ...
                                <div class="d-flex">
                                    @if(request()->type)
                                    <a href="{{route('admin.sw.expansion.seo',$set->id)}}" class="btn btn-primary mx-1">Main Set</a>
                                    @endif
                                    @if($set->single_count)
                                    <a href="{{route('admin.sw.expansion.seo',$set->id)}}?type=single" class="btn btn-primary mx-1">Single</a>
                                    @endif
                                    @if($set->sealed_count)
                                    <a href="{{route('admin.sw.expansion.seo',$set->id)}}?type=sealed" class="btn btn-primary mx-1">Sealed</a>
                                    @endif
                                    @if($set->completed_count)
                                    <a href="{{route('admin.sw.expansion.seo',$set->id)}}?type=completed" class="btn btn-primary mx-1">Complete</a>
                                    @endif
                                </div>
                            </div>
                            <div class="card-body mt-2">

                                <form method="POST" action="{{route('admin.sw.expansion.seo.store',$id)}}" class=""
