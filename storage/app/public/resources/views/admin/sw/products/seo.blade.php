                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.sw.products.seo.store')}}" method="post" enctype="multipart/form-data" class="submit_form">
                                    @csrf
                                    ...
                                    <div>
                                        ...
                                        <select name="set_id"  class="form-control select2">
                                            @foreach($sets as $set)
                                            <option class="form-control" value="{{$set->id}}" {{$set->id == $item->sw_set_id ? "selected" : ""}}>{{$set->name}}</option>
                                            @endforeach
                                        </select>
                    ...
                    {{-- <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                            @if($item->languages)
                                @foreach ($item->languages as $key => $language)
                                    <div class="col-md-2">
