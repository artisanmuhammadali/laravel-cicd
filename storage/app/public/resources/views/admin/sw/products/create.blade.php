                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.sw.products.store')}}" method="post" enctype="multipart/form-data" class="submit_form">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="set_id"  class="form-control select2 set_name required">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="other_card_type"  class="form-control select2 other_card_type required">
                                                <option class="from-conrtol" value="">Select one..</option>
                                                @foreach(wsCardsTypes() as $selaledType)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control card_meta required" name="text" ></textarea>
                                            <span class="badge badge-light-warning w-100">
                                                <i class="fa fa-exclamation-triangle me-75" aria-hidden="true"></i>
...
<script>
    ...
    function createCardSeo()
    {
        ...
        string = card_name+" | "+card_type+" | VFS Card Market";
