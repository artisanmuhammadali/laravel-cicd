...
class AnnouncementDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('end_on', function ($query) {
                return $query->viewend;
            })
            ->addColumn('action',function ($query){
                $item = $query;
                return view('admin.announcement.action',get_defined_vars());
            })
            ->rawColumns(['action']);
    }
    ...
    {
        $model = Announcement::query()->orderBy('created_at','desc');
    ...
    {
        return [
            ['data' => 'label', 'name' => 'label', 'title' => 'Label', 'orderable' => true,'searchable' => true,'width'=>30],
            ['data' => 'type', 'name' => 'type', 'title' => 'Type', 'orderable' => true,'searchable' => true,'width'=>30],
            ['data' => 'end_on', 'name' => 'end_on', 'title' => 'Valid Till', 'orderable' => true,'searchable' => true,'width'=>30],
