...
class SellerSurveyDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action',function ($query){
                return view('admin.survey.action',get_defined_vars());
            })
    ...
    {
        $model = SellerSurveyQuestion::query()->where('type','!=','answer');
    ...
    {
        return [
            ['data' => 'option', 'name' => 'option', 'title' => 'Question', 'orderable' => true],
