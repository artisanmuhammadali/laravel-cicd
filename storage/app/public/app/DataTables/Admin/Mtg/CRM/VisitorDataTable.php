...
class VisitorDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('created_at', function ($query) {
                return $query->created_at->format('Y/m/d H:m:s');
            })
            ->addColumn('total_visitors',function ($query){
                return $query->total_visitors;
            })
            ->rawColumns(['created_at','total_visitors']);
    }
    ...
    {
        $model = Visitor::select('ip', \DB::raw('COUNT(id) as total_visitors'))
        ->groupBy('ip')
    ...
    {
        return [
            ['data' => 'total_visitors', 'name' => 'total_visitors', 'title' => 'Total Visitors', 'orderable' => false],
