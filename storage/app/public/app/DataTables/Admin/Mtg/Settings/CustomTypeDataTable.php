...
namespace App\DataTables\Admin\Mtg\Settings;

use App\Models\MTG\MtgCustomSetType;
use Yajra\DataTables\Html\Column;
use Yajra\DataTables\Services\DataTable;

class CustomTypeDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action',function ($query){
                $item = $query;
                return view('admin.mtg.settings.customType.action',get_defined_vars());
            })
    ...
    protected function getColumns()
    {
        return [
            ...
            ['data' => 'created_at', 'name' => 'created_at', 'title' => 'Created_at', 'orderable' => true],
